...
Il repository contiene il file con le Specifiche ed è diviso in tre sezioni logiche:
...
## 3. `PROGETTO_OUTPUT/`
Completo di tutti i file generati dai codici in linguaggio python e dal codice in linguaggio C.
---
